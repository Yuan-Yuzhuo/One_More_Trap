...
| Asset | Usage | Source |
| --- | --- | --- |
| Simple 2D Platformer Assets Pack | Character sprite, spikes and platformer art base | Unity Asset Store: <https://assetstore.unity.com/packages/2d/characters/simple-2d-platformer-assets-pack-188518> |
| 2D Animated Coin - 2D RPK | Coin sprite | Unity Asset Store: <https://assetstore.unity.com/packages/2d/environments/2d-animated-coin-2d-rpk-22009> |
| Menu background, space background, doors, space station, spacecraft images, and other level-specific images | Game scenes and menu presentation | Generated by ChatGPT |
...
| `cadidate_1.mp3` | Main menu background music | Pixabay Background Music: <https://pixabay.com/music/bossa-nova-background-music-505061/> |

### Video

| Asset File | Usage | Source |
| --- | --- | --- |
| `Video Project.mp4` | Muted looping demo video in the main menu | Recorded by the developer |
